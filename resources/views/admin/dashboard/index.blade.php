                        ...
                        <div class="mt-5">
                                ...
                                <div class="d-flex align-items-center me-2">
                                    ...
                                    <div class="symbol symbol-50px me-3">
                                        <div class="symbol-label bg-light">
                                            <img src="/metronic/assets/media/svg/brand-logos/plurk.svg" class="h-50"
                                                alt="" />
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                            ...
                            <div class="d-flex flex-stack mb-5">
                                ...
                                <div class="d-flex align-items-center me-2">
                                    ...
                                    <div class="symbol symbol-50px me-3">
                                        <div class="symbol-label bg-light">
                                            <img src="/metronic/assets/media/svg/brand-logos/figma-1.svg" class="h-50"
                                                alt="" />
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center me-2">
                                    ...
                                    <div class="symbol symbol-50px me-3">
                                        <div class="symbol-label bg-light">
                                            <img src="/metronic/assets/media/svg/brand-logos/vimeo.svg" class="h-50"
                                                alt="" />
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                ...
                <div class="row gx-5 gx-xl-8 mb-5 mb-xl-8">
                    <div class="col-xxl-3">
                        ...
                        <div class="card h-150px bgi-no-repeat bgi-size-cover card-xxl-stretch"
                            style="background-image:url('/metronic/assets/media/stock/600x400/img-75.jpg')">
                            <!--begin::Body-->
                            <div class="card-body">
                                <!--begin::Title-->
                        ...
                        <div class="card h-150px card-xxl-stretch">
                            ...
                            <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
                                <div class="me-2">
                                    ...
                                    <div class="text-muted fw-bold fs-6">Generate the latest CRM report for company
                                        projects</div>
                                </div>
                ...
                <div class="row gx-5 gx-xl-8 mb-5 mb-xl-8">
                    ...
                    <div class="col-xxl-6">
                        ...
                        <div class="card h-175px bgi-no-repeat bgi-size-cover card-xxl-stretch mb-5 mb-xl-8"
                            style="background-color: #663259; background-position: calc(100% + 0.5rem) 100%;background-size: 100% auto;background-image:url('/metronic/assets/media/svg/misc/taieri.svg')">
                            <!--begin::Body-->
                    ...
                    <div class="col-xxl-6">
                        ...
                        <div class="card h-100 bgi-no-repeat bgi-size-cover card-xxl-stretch mb-5 mb-xl-8"
                            style="background-image:url('/metronic/assets/media/misc/bg-2.jpg')">
                            <!--begin::Body-->
                            <div class="card-body d-flex flex-column justify-content-between">
                                <!--begin::Title-->
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <div>
                                            <select class="form-select form-select-solid" data-kt-select2="true"
                                                ...
                                                data-dropdown-parent="#kt_menu_61484fe012b29" data-allow-clear="true">
                                                <option></option>
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#"
                                                        class="text-dark fw-bolder text-hover-primary fs-6">Ana Simmons</a>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#"
                                                        ...
                                                        Clarcson</a>
                                                    <span class="text-muted fw-bold text-muted d-block fs-7">C#, ASP.NET,
                                                        MS SQL</span>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-45px me-5">
                                                    <img src="/metronic/assets/media/avatars/150-4.jpg" alt="" />
                                                </div>
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-45px me-5">
                                                    <img src="/metronic/assets/media/avatars/150-5.jpg" alt="" />
                                                </div>
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#"
                                        ...
                                        <td>
                                            <a href="#"
                                                class="text-dark fw-bolder text-hover-primary d-block fs-6">The Hill</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-45px me-5">
                                                    <img src="/metronic/assets/media/avatars/150-6.jpg" alt="" />
                                                </div>
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#"
                    ...
                    <div class="card-body pt-2">
                        ...
                        <div class="d-flex align-items-center mb-7">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <img src="/metronic/assets/media/avatars/150-1.jpg" class="" alt="" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Text-->
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center mb-7">
                            <!--begin::Avatar-->
                            <div class="symbol symbol-50px me-5">
                                <img src="/metronic/assets/media/avatars/150-4.jpg" class="" alt="" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Text-->
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center mb-7">
                            <!--begin::Avatar-->
                            <div class="symbol symbol-50px me-5">
                                <img src="/metronic/assets/media/avatars/150-12.jpg" class="" alt="" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Text-->
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center mb-7">
                            <!--begin::Avatar-->
                            <div class="symbol symbol-50px me-5">
                                <img src="/metronic/assets/media/avatars/150-8.jpg" class="" alt="" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Text-->
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center">
                            <!--begin::Avatar-->
                            <div class="symbol symbol-50px me-5">
                                <img src="/metronic/assets/media/avatars/150-6.jpg" class="" alt="" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Text-->
                            <div class="flex-grow-1">
                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-body pt-5">
                        ...
                        <div class="d-flex align-items-sm-center mb-7">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <span class="symbol-label">
                                    <img src="/metronic/assets/media/svg/brand-logos/plurk.svg"
                        ...
                        <div class="d-flex align-items-sm-center mb-7">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <span class="symbol-label">
                                    <img src="/metronic/assets/media/svg/brand-logos/telegram.svg"
                                        class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <div class="d-flex align-items-sm-center mb-7">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <span class="symbol-label">
                                    <img src="/metronic/assets/media/svg/brand-logos/vimeo.svg"
                                        class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <div class="d-flex align-items-sm-center mb-7">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <span class="symbol-label">
                                    <img src="/metronic/assets/media/svg/brand-logos/bebo.svg"
                                        class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <div class="d-flex align-items-sm-center mb-7">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <span class="symbol-label">
                                    <img src="/metronic/assets/media/svg/brand-logos/kickstarter.svg"
                                        class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <!--end::Symbol-->
