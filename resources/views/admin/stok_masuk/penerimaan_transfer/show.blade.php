...
@push('toolbar')
    @include('layouts.partials._toolbar', [
        'title' => 'Detail Penerimaan Transfer',
        'breadcrumbs' => ['Admin', 'Stok Masuk', 'Penerimaan Transfer', 'Detail'],
    ])
@endpush
                ...
                <div class="d-flex flex-column flex-xl-row">
                    ...
                    <div class="flex-lg-row-fluid me-xl-18 mb-10 mb-xl-0">
                        ...
                        <div class="mt-n1">
                            ...
                            <div class="m-0">
                                <!--begin::Label-->
                                <div class="fw-bolder fs-3 text-gray-800 mb-8">Penerimaan Transfer
