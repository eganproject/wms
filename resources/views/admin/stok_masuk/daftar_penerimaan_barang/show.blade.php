...
@push('toolbar')
    @include('layouts.partials._toolbar', [
        ...
        'breadcrumbs' => ['Admin', 'Stok Masuk', 'Daftar Penerimaan Barang', 'Detail'],
    ])
@endpush
                        ...
                        <div class="mt-n1">
                            ...
                            <div class="m-0">
                                ...
                                <div class="row g-5 mb-11">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="fw-bolder fs-6 text-gray-800 d-flex align-items-center flex-wrap">
                                            <span class="pe-2">{{ $stockInOrder->warehouse->name }}</span>
                                        </div>
                                        <!--end::Info-->
                                    </div>
                                    <!--end::Col-->
                                ...
                                <div class="row g-5 mb-12">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="fw-bolder fs-6 text-gray-800">
                                            @php
                                                $badgeClass = 'primary';
                                                if ($stockInOrder->status === 'completed') {
                                                    $badgeClass = 'success';
                                                } elseif ($stockInOrder->status === 'rejected') {
                                                    $badgeClass = 'danger';
                                                }
                                            @endphp
                                            <span
                                ...
                                <div class="mb-0">
                                    ...
                                    <div class="fw-bold fs-6 text-gray-800">{{ $stockInOrder->description ?? '-' }}</div>
                                </div>
                                <!--end::Notes-->
                            </div>
                            <!--end::Wrapper-->
