...
<div class="card">
    <div class="card-body">
        <form id="transfer-request-form" action="{{ route('admin.transfergudang.buat-permintaan-transfer.store') }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-md-4 mb-5">
                    <label class="form-label">Kode Permintaan</label>
                    <input type="text" name="code" class="form-control form-control-solid @error('code') is-invalid @enderror" value="{{ $code }}" readonly/>
                </div>
                <div class="col-md-4 mb-5">
            ...
            <div class="mt-10">
                ...
                <a href="{{ route('admin.transfergudang.buat-permintaan-transfer.index') }}" class="btn btn-light">Batal</a>
            </div>
        </form>
    </div>
</div>
